(function () {
    ...
    {
        "step_id": "step_1",
        "text": "Goal: show Shanghai Composite daily price action with trend context. The screen combines a detailed candlestick chart, four moving‑average lines, annotations, a legend, and a bottom overview slider.",
        "step_type": "structure",
        "targets": {
    ...
    {
        "step_id": "step_2",
        "text": "Use the bottom mini‑timeline for a high‑level summary; it frames the date window shown above. The upper candlesticks provide detailed day‑to‑day movement within that window.",
        "step_type": "structure",
        "targets": {
            "target_view_id": "overview_zoom",
            "resolvedSelector": "g[clip-path=\"url(#zr0-c4)\"] path[stroke=\"#d2dbee\" i], g[clip-path=\"url(#zr0-c5)\"] path[stroke=\"#8fb0f7\" i], g[clip-path=\"url(#zr0-c6)\"] path[stroke=\"#d2dbee\" i]",
            "raw": {
                "view": {
                    "candidates": [
                        {
                            "selector": "path[transform=\"matrix(1,0,0,-1,156.4,779.9)\"][stroke=\"#d2dbee\" i]",
                            "confidence": "high",
                            "reason": "dataZoom slider border enclosing the overview area"
                        },
                        {
                            "selector": "g[clip-path=\"url(#zr0-c4)\"], g[clip-path=\"url(#zr0-c5)\"], g[clip-path=\"url(#zr0-c6)\"]",
                            "confidence": "high",
                            "reason": "containers that clip the mini-series inside the zoom bar"
                        }
                    ]
                },
                "encoding": {
                    "candidates": [
                        {
                            "selector": "g[clip-path=\"url(#zr0-c4)\"] path[fill=\"#d2dbee\" i], g[clip-path=\"url(#zr0-c5)\"] path[fill=\"#8fb0f7\" i], g[clip-path=\"url(#zr0-c6)\"] path[fill=\"#d2dbee\" i]",
                            "confidence": "high",
                            "reason": "overview area shapes inside data zoom"
                        },
                        {
                            "selector": "g[clip-path=\"url(#zr0-c4)\"] path[stroke=\"#d2dbee\" i], g[clip-path=\"url(#zr0-c5)\"] path[stroke=\"#8fb0f7\" i], g[clip-path=\"url(#zr0-c6)\"] path[stroke=\"#d2dbee\" i]",
                            "confidence": "high",
                            "reason": "overview stroke outlines"
                        }
                    ]
                },
                "interaction": {
                    "candidates": [
                        {
                            "selector": "path[transform^=\"matrix(15,0,0,-15,\"][stroke=\"#ACB8D1\" i]",
                            "confidence": "high",
                            "reason": "draggable dataZoom handles"
                        },
                        {
                            "selector": "path[transform=\"matrix(1,0,0,-1,156.4,779.9)\"][fill=\"#D2DBEE\" i]",
                            "confidence": "medium",
                            "reason": "selection window highlight within the zoom bar"
                        }
                    ]
                }
            }
    ...
    {
        "step_id": "step_3",
        "text": "The legend links colors to series: blue MA5, green MA10, yellow MA20, red MA30. Match each colored dot on the lines to these labels.",
        "step_type": "structure",
        "targets": {
            "target_view_id": "legend_series",
            "resolvedSelector": "path[transform=\"translate(596.7256 26)\"][fill=\"#ec0000\" i][stroke=\"#8A0000\" i]",
            "raw": {
                "view": {
                    "candidates": [
                        {
                            "selector": "path[transform=\"matrix(1,0,0,-1,156.4,779.9)\"][fill=\"rgb(135,175,255)\" i]",
                            "confidence": "high",
                            "reason": "legend/top bar background area"
                        },
                        {
                            "selector": "path[transform=\"matrix(1,0,0,-1,156.4,779.9)\"][stroke=\"#d2dbee\" i]",
                            "confidence": "high",
                            "reason": "legend container border"
                        }
                    ]
                },
                "encoding": {
                    "candidates": [
                        {
                            "selector": "path[transform=\"translate(596.7256 26)\"][fill=\"#ec0000\" i][stroke=\"#8A0000\" i]",
                            "confidence": "high",
                            "reason": "legend item symbol for candlestick series"
                        },
                        {
                            "selector": "path[transform=\"translate(657.3428 26)\"][stroke=\"#5470c6\" i]",
                            "confidence": "high",
                            "reason": "legend line for MA5"
                        },
                        {
                            "selector": "path[d^=\"M18.1 7A5.6 5.6\"][transform=\"translate(657.3428 26)\"][stroke=\"#5470c6\" i]",
                            "confidence": "high",
                            "reason": "legend point marker for MA5"
                        },
                        {
                            "selector": "path[transform=\"translate(725.5479 26)\"][stroke=\"#91cc75\" i]",
                            "confidence": "high",
                            "reason": "legend line for MA10"
                        },
                        {
                            "selector": "path[transform=\"translate(800.79 26)\"][stroke=\"#fac858\" i]",
                            "confidence": "high",
                            "reason": "legend line for MA20"
                        },
                        {
                            "selector": "path[transform=\"translate(876.0322 26)\"][stroke=\"#ee6666\" i]",
                            "confidence": "high",
                            "reason": "legend line for MA30"
                        },
                        {
                            "selector": "text[transform=\"translate(657.3428 26)\"], text[transform=\"translate(725.5479 26)\"], text[transform=\"translate(800.79 26)\"], text[transform=\"translate(876.0322 26)\"]",
                            "confidence": "high",
                            "reason": "legend labels MA5/MA10/MA20/MA30"
                        }
                    ]
                },
                "interaction": {
                    "candidates": [
                        {
                            "selector": "path[transform=\"translate(596.7256 26)\"], path[transform=\"translate(657.3428 26)\"], path[transform=\"translate(725.5479 26)\"], path[transform=\"translate(800.79 26)\"], path[transform=\"translate(876.0322 26)\"], text[transform=\"translate(657.3428 26)\"], text[transform=\"translate(725.5479 26)\"], text[transform=\"translate(800.79 26)\"], text[transform=\"translate(876.0322 26)\"]",
                            "confidence": "high",
                            "reason": "legend items are typical click/hover targets to toggle series"
                        }
                    ]
                }
            }
    ...
    {
        "step_id": "step_4",
        "text": "Each candlestick represents one trading day from 2013/4/8 to 2013/6/13. Index values are in points on the left axis, roughly 2,100–2,350.",
        "step_type": "data",
        "targets": {
            "target_view_id": "candles_main",
            "resolvedSelector": "path[fill=\"#ec0000\" i][stroke=\"#8A0000\" i]",
            "raw": {
                "view": {
                    "candidates": [
                        {
                            "selector": "svg > g",
                            "confidence": "medium",
                            "reason": "top-level chart container holding candlesticks and other series"
                        }
                    ]
                },
                "encoding": {
                    "candidates": [
                        {
                            "selector": "path[fill=\"#ec0000\" i][stroke=\"#8A0000\" i]",
                            "confidence": "high",
                            "reason": "down candles: red bodies with matching dark red stroke"
                        },
                        {
                            "selector": "path[fill=\"#00da3c\" i][stroke=\"#008F28\" i]",
                            "confidence": "high",
                            "reason": "up candles: green bodies with matching green stroke"
                        },
                        {
                            "selector": "path[fill=\"rgb(236,0,0)\" i][stroke=\"#8A0000\" i]",
                            "confidence": "high",
                            "reason": "down candles variant using rgb color"
                        },
                        {
                            "selector": "path[fill=\"rgb(0,218,60)\" i][stroke=\"#008F28\" i]",
                            "confidence": "high",
                            "reason": "up candles variant using rgb color"
                        }
                    ]
                },
                "interaction": {
                    "candidates": [
                        {
                            "selector": "path[fill=\"#ec0000\" i][stroke=\"#8A0000\" i], path[fill=\"#00da3c\" i][stroke=\"#008F28\" i], path[fill=\"rgb(236,0,0)\" i][stroke=\"#8A0000\" i], path[fill=\"rgb(0,218,60)\" i][stroke=\"#008F28\" i]",
                            "confidence": "medium",
                            "reason": "candlestick paths function as hover targets for tooltips"
                        }
                    ]
                }
            }
    ...
    {
        "step_id": "step_5",
        "text": "Read an individual candle body: rectangle top/bottom encode close and open, thin wicks mark high/low. A red rectangle means price rose; a green rectangle means price fell.",
        "step_type": "encoding",
        "targets": {
            "target_view_id": "candles_main",
            "resolvedSelector": "path[fill=\"#ec0000\" i][stroke=\"#8A0000\" i]",
    ...
    {
        "step_id": "step_6",
        "text": "Follow the blue line: each colored dot is the 5‑day moving average for that date. The connected line segment shows short‑term momentum.",
        "step_type": "encoding",
        "targets": {
            "target_view_id": "ma5_line",
            "resolvedSelector": "g[clip-path=\"url(#zr0-c0)\"] > path[stroke=\"rgb(84,112,198)\" i]",
            "raw": {
                "view": {
                    "candidates": [
                        {
                            "selector": "g[clip-path=\"url(#zr0-c0)\"]",
                            "confidence": "high",
                            "reason": "series container clipped to main plotting area"
                        }
                    ]
                },
                "encoding": {
                    "candidates": [
                        {
                            "selector": "g[clip-path=\"url(#zr0-c0)\"] > path[stroke=\"rgb(84,112,198)\" i]",
                            "confidence": "high",
                            "reason": "MA5 polyline stroke color (#5470c6)"
                        },
                        {
                            "selector": "path[stroke=\"#5470c6\" i][transform^=\"matrix(2,0,0,2,\"]",
                            "confidence": "high",
                            "reason": "MA5 point markers rendered as small circular paths"
                        }
                    ]
                },
                "interaction": {
                    "candidates": [
                        {
                            "selector": "path[stroke=\"#5470c6\" i][transform^=\"matrix(2,0,0,2,\"]",
                            "confidence": "medium",
                            "reason": "hoverable markers along MA5"
                        }
                    ]
                }
            }
    ...
    {
        "step_id": "step_7",
        "text": "The left axis is shared by candlesticks and all lines; a higher vertical position equals a higher index level.",
        "step_type": "structure",
        "targets": {
            "target_view_id": "y_axis_main",
            "resolvedSelector": "path[stroke=\"#E0E6F1\" i]",
            "raw": {
                "view": {
                    "candidates": [
                        {
                            "selector": "svg > g",
                            "confidence": "medium",
                            "reason": "y-axis lines and labels reside in main group"
                        }
                    ]
                },
                "encoding": {
                    "candidates": [
                        {
                            "selector": "path[stroke=\"#E0E6F1\" i]",
                            "confidence": "high",
                            "reason": "y-axis gridlines across the plot"
                        },
                        {
                            "selector": "text[text-anchor=\"end\"][fill=\"#6E7079\" i]",
                            "confidence": "high",
                            "reason": "y-axis tick labels on the left"
                        }
                    ]
                },
                "interaction": {
                    "candidates": [
                        {
                            "selector": "text[text-anchor=\"end\"][fill=\"#6E7079\" i]",
                            "confidence": "low",
                            "reason": "labels may support tooltips in some configurations"
                        }
                    ]
                }
            }
    ...
    {
        "step_id": "step_8",
        "text": "The bottom dates align every candle and colored dot to the same trading day, enabling direct cross‑series comparison.",
        "step_type": "structure",
        "targets": {
            "target_view_id": "x_axis_main",
            "resolvedSelector": "path[d^=\"M153.6 702.5L\"][stroke=\"#6E7079\" i]",
            "raw": {
                "view": {
                    "candidates": [
                        {
                            "selector": "svg > g",
                            "confidence": "medium",
                            "reason": "axis elements are direct children of the main group"
                        }
                    ]
                },
                "encoding": {
                    "candidates": [
                        {
                            "selector": "path[d^=\"M153.6 702.5L\"][stroke=\"#6E7079\" i]",
                            "confidence": "high",
                            "reason": "x-axis baseline line"
                        },
                        {
                            "selector": "path[stroke=\"#6E7079\" i][d*=\"707.1\"]",
                            "confidence": "medium",
                            "reason": "x-axis tick marks at the bottom"
                        },
                        {
                            "selector": "text[transform*=\" 710.1)\"][fill=\"#6E7079\" i][text-anchor=\"middle\"]",
                            "confidence": "high",
                            "reason": "x-axis tick labels"
                        }
                    ]
                },
                "interaction": {
                    "candidates": [
                        {
                            "selector": "text[transform*=\" 710.1)\"][fill=\"#6E7079\" i]",
                            "confidence": "low",
                            "reason": "labels can be hover targets in some interactions"
                        }
                    ]
                }
            }
    ...
    {
        "step_id": "step_9",
        "text": "Look for the blue MA5 crossing below the yellow MA20 in early June. That downward crossover signals weakening momentum and often precedes further declines.",
    ...
    {
        "step_id": "step_10",
        "text": "Notice the sequence of tall green candles after 2013/6/5 dropping beneath all colored lines. This cluster indicates strong selling pressure and a break below trend support.",
        "step_type": "analytical",
        "targets": {
            "target_view_id": "candles_main",
            "resolvedSelector": "path[fill=\"#ec0000\" i][stroke=\"#8A0000\" i]",
    ...
    {
        "step_id": "step_11",
        "text": "Use the dashed horizontal guides near the specific marks 2324 and 2148. When a candle pierces these lines, it suggests resistance or support is being tested.",
        "step_type": "analytical",
        "targets": {
            "target_view_id": "annotations_marks",
            "resolvedSelector": "path[stroke=\"#ec0000\" i][stroke-dasharray=\"4,2\"]",
            "raw": {
                "view": {
                    "candidates": [
                        {
                            "selector": "svg > g",
                            "confidence": "medium",
                            "reason": "overlay annotations drawn in the main group"
                        }
                    ]
                },
                "encoding": {
                    "candidates": [
                        {
                            "selector": "path[stroke=\"#ec0000\" i][stroke-dasharray=\"4,2\"]",
                            "confidence": "high",
                            "reason": "dashed guide lines for annotations"
                        },
                        {
                            "selector": "path[transform^=\"matrix(25,0,0,25,\"][fill=\"#ec0000\" i]",
                            "confidence": "high",
                            "reason": "red callout pins/markers"
                        },
                        {
                            "selector": "path[transform^=\"matrix(25,0,0,25,\"][fill=\"rgb(41,60,85)\" i]",
                            "confidence": "high",
                            "reason": "dark callout pin marker"
                        },
                        {
                            "selector": "path[transform^=\"matrix(\"][fill=\"#ec0000\" i]",
                            "confidence": "medium",
                            "reason": "arrowheads and annotation shapes rendered via transform matrices"
                        },
                        {
                            "selector": "text[stroke=\"#ec0000\" i]",
                            "confidence": "high",
                            "reason": "annotation labels with red stroke (e.g., 2334, 2126)"
                        }
                    ]
                },
                "interaction": {
                    "candidates": [
                        {
                            "selector": "path[stroke=\"#ec0000\" i][stroke-dasharray=\"4,2\"], path[transform^=\"matrix(25,0,0,25,\"][fill=\"#ec0000\" i], text[stroke=\"#ec0000\" i]",
                            "confidence": "medium",
                            "reason": "annotation lines and pins typically respond to hover/tooltips"
                        }
                    ]
                }
            }
    ...
    {
        "step_id": "step_12",
        "text": "Follow the dashed diagonal from the red marker bubble 2334 down to the red marker bubble 2126. This specific mark visualizes the peak‑to‑trough drawdown magnitude.",
        "step_type": "analytical",
        "targets": {
            "target_view_id": "annotations_marks",
            "resolvedSelector": "path[stroke=\"#ec0000\" i][stroke-dasharray=\"4,2\"]",
    ...
    {
        "step_id": "step_13",
        "text": "Drag the white handles in the bottom overview to expand or narrow the date range displayed in the main chart.",
    ...
    {
        "step_id": "step_14",
        "text": "Workflow: start with the overview to choose a span, then scan individual candles, and finally compare colored dots of MA lines and annotations for context.",
        "step_type": "interaction",
        "targets": {
            "target_view_id": "overview_zoom",
            "resolvedSelector": "g[clip-path=\"url(#zr0-c4)\"] path[stroke=\"#d2dbee\" i], g[clip-path=\"url(#zr0-c5)\"] path[stroke=\"#8fb0f7\" i], g[clip-path=\"url(#zr0-c6)\"] path[stroke=\"#d2dbee\" i]",
