(function () {
    ...
    {
        "step_id": "step_1",
        "text": "This visualization combines a small overview on top and a detailed month‑by‑month chart below, plus a legend and multiple axes on the right. Use them together to compare lines and bars across months.",
        "step_type": "structure",
        "targets": {
    ...
    {
        "step_id": "step_2",
        "text": "Start with the top overview to spot peaks and dips, then move to the large chart to read exact values on each colored dot and bar.",
        "step_type": "structure",
        "targets": {
            "target_view_id": "overview_preview",
            "resolvedSelector": "path.myChart-graph-id0-plotset-plot-0-preview",
            "raw": {
                "view": {
                    "candidates": [
                        {
                            "selector": "#myChart-graph-id0-preview",
                            "confidence": "high",
                            "reason": "container or structural grouping"
                        },
                        {
                            "selector": "#myChart-graph-id0-preview-c",
                            "confidence": "high",
                            "reason": "container or structural grouping"
                        }
                    ]
                ...
                "encoding": {
                    "candidates": [
                        {
                            "selector": "path.myChart-graph-id0-plotset-plot-0-preview",
                            "confidence": "high",
                            "reason": "marks that visually encode data"
                        },
                        {
                            "selector": "path.myChart-graph-id0-plotset-plot-1-preview",
                            "confidence": "high",
                            "reason": "marks that visually encode data"
                        },
                        {
                            "selector": "path.myChart-graph-id0-plotset-plot-2-preview",
                            "confidence": "high",
                            "reason": "marks that visually encode data"
                        },
                        {
                            "selector": "path.myChart-graph-id0-plotset-plot-3-preview",
                            "confidence": "high",
                            "reason": "marks that visually encode data"
                        }
                    ]
                ...
                "interaction": {
                    "candidates": [
                        {
                            "selector": "#myChart-graph-id0-preview-viewport-path",
                            "confidence": "high",
                            "reason": "elements supporting interaction"
                        }
                    ]
                }
            }
    ...
    {
        "step_id": "step_3",
        "text": "The month labels along the bottom align every colored dot and bar to Jan–Dec, keeping the timeline consistent across all series.",
        "step_type": "structure",
        "targets": {
            "target_view_id": "axis_x_bottom_months",
            "resolvedSelector": "#myChart-graph-id0-scale-x-path",
            "raw": {
                "view": {
                    "candidates": [
                        {
                            ...
                            "confidence": "high",
                            "reason": "container for main axes"
                        }
                    ]
                },
                "encoding": {
                    "candidates": [
                        {
                            ...
                            "confidence": "high",
                            "reason": "axis baseline and ticks"
                        },
                        {
                            "selector": "text.myChart-graph-id0-scale-x-item",
                            "confidence": "high",
                            "reason": "axis tick labels (months)"
                        }
                    ]
                },
                "interaction": {
                    "candidates": [
                        {
                            "selector": "text.myChart-graph-id0-scale-x-item",
                            "confidence": "medium",
                            "reason": "labels used for hover/click selection"
                        }
                    ]
                }
            }
    ...
    {
        "step_id": "step_4",
        "text": "The legend links Series 1 to the blue line and Series 2 to the red line for quick identification.",
        "step_type": "data",
        "targets": {
            "target_view_id": "legend_panel",
            "resolvedSelector": "#myChart-graph-id0-legend-marker_0-circle",
            "raw": {
                "view": {
                    "candidates": [
                        {
                        ...
                        {
                            "selector": "#myChart-graph-id0-legend-path",
                            "confidence": "high",
                            "reason": "legend panel background"
                        }
                    ]
                },
                "encoding": {
                    "candidates": [
                        {
                            "selector": "#myChart-graph-id0-legend-marker_0-circle",
                            "confidence": "high",
                            "reason": "legend color swatch for Series 1"
                        },
                        {
                            "selector": "#myChart-graph-id0-legend-marker_1-circle",
                            "confidence": "high",
                            "reason": "legend color swatch for Series 2"
                        }
                    ]
                },
                "interaction": {
                    "candidates": [
                        {
                            "selector": "text.myChart-graph-id0-legend-item",
                            "confidence": "medium",
                            "reason": "legend items toggling series"
                        },
                        {
                            "selector": "#myChart-graph-id0-legend-page-prev-path",
                            "confidence": "high",
                            "reason": "legend pagination control"
                        },
                        {
                            "selector": "#myChart-graph-id0-legend-page-next-path",
                            "confidence": "high",
                            "reason": "legend pagination control"
                        }
                    ]
    ...
    {
        "step_id": "step_5",
        "text": "Green bars represent monthly percentages scaled 0–100%; use them to track rate changes by month.",
        "step_type": "data",
        "targets": {
            "target_view_id": "main_bars_green",
            "resolvedSelector": "path.myChart-graph-id0-plotset-plot-2-node-area[fill=\"#1B5E20\" i]",
            "raw": {
                "view": {
                    "candidates": [
                        {
                            "selector": "#myChart-graph-id0-plot-2-bl-1-c",
                            "confidence": "high",
                            "reason": "container or structural grouping"
                        }
                    ]
                ...
                "encoding": {
                    "candidates": [
                        {
                            "selector": "path.myChart-graph-id0-plotset-plot-2-node-area[fill=\"#1B5E20\" i]",
                            "confidence": "high",
                            "reason": "marks that visually encode data"
                        },
                        {
                            "selector": "text.myChart-graph-id0-plot-2-value-box",
                            "confidence": "medium",
                            "reason": "value labels tied to bar marks"
                        }
                    ]
                },
                "interaction": {
                    "candidates": [
                        {
                            "selector": "path.myChart-graph-id0-plotset-plot-2-node-area.zc-node-area",
                            "confidence": "high",
                            "reason": "elements supporting interaction"
                        }
                    ]
    ...
    {
        "step_id": "step_6",
        "text": "Orange bars represent monthly amounts labeled in thousands (K), aligned with the $ scale on the far‑right axis.",
        "step_type": "data",
        "targets": {
            "target_view_id": "main_bars_orange",
            "resolvedSelector": "path.myChart-graph-id0-plotset-plot-3-node-area[fill=\"#E65100\" i]",
            "raw": {
                "view": {
                    "candidates": [
                        {
                ...
                "encoding": {
                    "candidates": [
                        {
                            "selector": "path.myChart-graph-id0-plotset-plot-3-node-area[fill=\"#E65100\" i]",
                            "confidence": "high",
                            "reason": "marks that visually encode data"
                        },
                        {
                            "selector": "text.myChart-graph-id0-plot-3-value-box",
                            "confidence": "medium",
                            "reason": "value labels tied to bar marks"
                        }
                    ]
                ...
                "interaction": {
                    "candidates": [
                        {
                            "selector": "path.myChart-graph-id0-plotset-plot-3-node-area.zc-node-area",
                            "confidence": "high",
                            "reason": "elements supporting interaction"
                        }
                    ]
    ...
    {
        "step_id": "step_7",
        "text": "Each blue colored dot marks one month; its vertical position reads from the left Y label, while the connecting line shows change over time.",
        "step_type": "encoding",
        "targets": {
            "target_view_id": "main_line_blue",
            "resolvedSelector": "#myChart-graph-id0-plotset-plot-0-path",
            "raw": {
                "view": {
                    "candidates": [
                        {
                ...
                "encoding": {
                    "candidates": [
                        {
                            "selector": "#myChart-graph-id0-plotset-plot-0-path",
                            "confidence": "high",
                            "reason": "marks that visually encode data"
                        },
                        {
                            "selector": "path[stroke=\"#0D47A1\" i]",
                            "confidence": "medium",
                            "reason": "marks that visually encode data"
                        },
                        {
                            "selector": "circle.myChart-graph-id0-plotset-plot-0-node-area[fill=\"#0D47A1\" i]",
                            "confidence": "high",
                            "reason": "marks that visually encode data"
                        }
                    ]
                ...
                "interaction": {
                    "candidates": [
                        {
                            "selector": "circle.myChart-graph-id0-plotset-plot-0-node-area",
                            "confidence": "high",
                            "reason": "elements supporting interaction"
                        }
                    ]
    ...
    {
        "step_id": "step_8",
        "text": "Each red colored dot behaves similarly for Series 2, using the left Y label for value and the line for month‑to‑month movement.",
        "step_type": "encoding",
        "targets": {
            "target_view_id": "main_line_red",
            "resolvedSelector": "#myChart-graph-id0-plotset-plot-1-path",
            "raw": {
                "view": {
                    "candidates": [
                        {
                ...
                "encoding": {
                    "candidates": [
                        {
                            "selector": "#myChart-graph-id0-plotset-plot-1-path",
                            "confidence": "high",
                            "reason": "marks that visually encode data"
                        },
                        {
                            "selector": "path[stroke=\"#B71C1C\" i]",
                            "confidence": "medium",
                            "reason": "marks that visually encode data"
                        },
                        {
                            "selector": "circle.myChart-graph-id0-plotset-plot-1-node-area[fill=\"#B71C1C\" i]",
                            "confidence": "high",
                            "reason": "marks that visually encode data"
                        }
                    ]
                ...
                "interaction": {
                    "candidates": [
                        {
                            "selector": "circle.myChart-graph-id0-plotset-plot-1-node-area",
                            "confidence": "high",
                            "reason": "elements supporting interaction"
                        }
                    ]
    ...
    {
        "step_id": "step_9",
        "text": "A green bar’s height encodes percent using the Y‑2 label on the right; the white value label inside repeats the exact percentage.",
        "step_type": "encoding",
        "targets": {
            "target_view_id": "main_bars_green",
            "resolvedSelector": "path.myChart-graph-id0-plotset-plot-2-node-area[fill=\"#1B5E20\" i]",
    ...
    {
        "step_id": "step_10",
        "text": "An orange bar’s height encodes the 'K' amount using the Y‑4 $ axis; the white value label shows the exact thousands.",
        "step_type": "encoding",
        "targets": {
            "target_view_id": "main_bars_orange",
            "resolvedSelector": "path.myChart-graph-id0-plotset-plot-3-node-area[fill=\"#E65100\" i]",
    ...
    {
        "step_id": "step_11",
        "text": "Match marks to axes: green bars read from the Y‑2 % axis, orange bars from the Y‑4 $ axis, while lines use the left Y label.",
        "step_type": "structure",
        "targets": {
            "target_view_id": "axis_y2_right_percent",
            "resolvedSelector": "#myChart-graph-id0-scale-y-2-tick-10-path",
            "raw": {
                "view": {
                    "candidates": [
                        {
                            "selector": "#myChart-graph-id0-scales-ml-0-c",
                            "confidence": "high",
                            "reason": "container for auxiliary axes"
                        }
                    ]
                },
                "encoding": {
                    "candidates": [
                        {
                            "selector": "#myChart-graph-id0-scale-y-2-path",
                            "confidence": "high",
                            "reason": "right y-2 axis baseline"
                        },
                        {
                            "selector": "#myChart-graph-id0-scale-y-2-tick-10-path",
                            "confidence": "high",
                            "reason": "ticks for right y-2 axis"
                        },
                        {
                            "selector": "text.myChart-graph-id0-scale-y-2-item",
                            "confidence": "high",
                            "reason": "y-2 tick labels (percent)"
                        }
                    ]
                },
                "interaction": {
    ...
    {
        "step_id": "step_12",
        "text": "The top X‑2 label numbers (1–10) index positions across the same timeline, helpful when months are abbreviated.",
        "step_type": "data",
        "targets": {
            "target_view_id": "axis_x2_top_numbers",
            "resolvedSelector": "#myChart-graph-id0-scale-x-2-path",
            "raw": {
                "view": {
                    "candidates": [
                        {
                            "selector": "#myChart-graph-id0-scales-ml-0-c",
                            "confidence": "high",
                            "reason": "container for top x-2 axis"
                        }
                    ]
                },
                "encoding": {
                    "candidates": [
                        {
                            "selector": "#myChart-graph-id0-scale-x-2-path",
                            "confidence": "high",
                            "reason": "top axis baseline and ticks"
                        },
                        {
                            "selector": "text.myChart-graph-id0-scale-x-2-item",
                            "confidence": "high",
                            "reason": "top axis numeric tick labels"
                        }
                    ]
                },
                "interaction": {
                    "candidates": [
                        {
                            "selector": "text#myChart-graph-id0-scale_x_2-item_title",
                            "confidence": "medium",
                            "reason": "axis title interaction"
                        }
                    ]
    ...
    {
        "step_id": "step_13",
        "text": "Look for the run‑up of blue colored dots peaking near Jul; this signals Series 1’s annual high and sets a reference for surrounding months.",
    ...
    {
        "step_id": "step_14",
        "text": "Compare Jul’s tall green bar (12.1%) to Aug’s shorter 7.8% bar; the sharp drop highlights a brief spike that quickly cooled.",
        "step_type": "analytical",
        "targets": {
            "target_view_id": "main_bars_green",
            "resolvedSelector": "path.myChart-graph-id0-plotset-plot-2-node-area[fill=\"#1B5E20\" i]",
    ...
    {
        "step_id": "step_15",
        "text": "Scan for orange bars with large white labels like 330K and 410K; these outliers identify months with unusually high quantities.",
        "step_type": "analytical",
        "targets": {
            "target_view_id": "main_bars_orange",
            "resolvedSelector": "path.myChart-graph-id0-plotset-plot-3-node-area[fill=\"#E65100\" i]",
    ...
    {
        "step_id": "step_16",
        "text": "Use the bold horizontal reference line: colored dots above it exceed the target level, and dots below fall short for that month.",
        "step_type": "analytical",
        "targets": {
            "target_view_id": "reference_line_threshold",
            "resolvedSelector": "#myChart-graph-id0-scale-y-marker-0-path",
            "raw": {
                "view": {
                    "candidates": [
                        {
                ...
                "encoding": {
                    "candidates": [
                        {
                            "selector": "#myChart-graph-id0-scale-y-marker-0-path",
                            "confidence": "high",
                            "reason": "horizontal reference line mark"
                        },
                        {
                            "selector": "path#myChart-graph-id0-scale-y-marker-0-path[stroke=\"#212121\" i]",
                            "confidence": "high",
                            "reason": "precise style of reference line"
                        }
                    ]
                },
                "interaction": {
                    "candidates": [
                        {
                            "selector": "#myChart-graph-id0-scale-y-marker-0-path",
                            "confidence": "low",
                            "reason": "line can be used for hover in some charts"
                        }
                    ]
                }
            }
    ...
    {
        "step_id": "step_17",
        "text": "Focus on the light‑green shaded block labeled Active Month around Jul–Aug; reading all marks together there reveals the post‑peak cooldown.",
        "step_type": "analytical",
        "targets": {
            "target_view_id": "active_period_highlight",
            "resolvedSelector": "#myChart-graph-id0-scale-x-marker-0-path",
            "raw": {
                "view": {
                    "candidates": [
                        {
                ...
                "encoding": {
                    "candidates": [
                        {
                            "selector": "#myChart-graph-id0-scale-x-marker-0-path",
                            "confidence": "high",
                            "reason": "highlight region rectangle"
                        },
                        {
                            "selector": "path#myChart-graph-id0-scale-x-marker-0-path[fill=\"#66BB6A\" i]",
                            "confidence": "high",
                            "reason": "precise highlight by color"
                        }
                    ]
                },
                "interaction": {
                    "candidates": [
                        {
                            "selector": "text#myChart-graph-id0-scale_x-marker_0",
                            "confidence": "medium",
                            "reason": "marker label often hoverable/clickable"
                        },
                        {
                            "selector": "#myChart-graph-id0-scale-x-marker-0-path",
                            "confidence": "medium",
                            "reason": "region used for hover/selection"
                        }
                    ]
                }
            }
    ...
    {
        "step_id": "step_18",
        "text": "From the overview peak at position 6–7, jump to the same months below and compare the blue dot with both the green and orange bars.",
        "step_type": "analytical",
        "targets": {
            "target_view_id": "overview_preview",
            "resolvedSelector": "path.myChart-graph-id0-plotset-plot-0-preview",
    ...
    {
        "step_id": "step_19",
        "text": "Use the small arrows in the legend to page through items (Page 1 of 2) when additional legend entries are available.",
    ...
    {
        "step_id": "step_20",
        "text": "Drag the legend by its cross icon to reposition it if it obstructs a colored dot or bar.",
        "step_type": "interaction",
        "targets": {
            "target_view_id": "legend_panel",
            "resolvedSelector": "#myChart-graph-id0-legend-marker_0-circle",
    ...
    {
        "step_id": "step_21",
        "text": "Click the box icon in the legend header to collapse the legend and maximize space for marks.",
        "step_type": "interaction",
        "targets": {
            "target_view_id": "legend_panel",
            "resolvedSelector": "#myChart-graph-id0-legend-marker_0-circle",
    ...
    {
        "step_id": "step_22",
        "text": "Click the underlined 'View External Report' callout to open the linked report for deeper context.",
        "step_type": "interaction",
        "targets": {
            "target_view_id": "annotation_external_report",
            "resolvedSelector": "#myChart-graph-id0-label-lbl_0_7458-path",
            "raw": {
                "view": {
                    "candidates": [
                        {
                            "selector": "#myChart-graph-id0-objects-top-c",
                            "confidence": "high",
                            "reason": "container or structural grouping"
                        }
                    ]
                ...
                "encoding": {
                    "candidates": [
                        {
                            "selector": "#myChart-graph-id0-label-lbl_0_7458-path",
                            "confidence": "high",
                            "reason": "callout bubble shape"
                        },
                        {
                            "selector": "#myChart-graph-id0-label-lbl_0_7458",
                            "confidence": "high",
                            "reason": "annotation text content"
                        }
                    ]
                },
                "interaction": {
                    "candidates": [
                        {
                            "selector": "#myChart-graph-id0-label-lbl_0_7458",
                            "confidence": "medium",
                            "reason": "annotation label intended for click"
                        },
                        {
                            "selector": "#myChart-graph-id0-label-lbl_0_7458-path",
                            "confidence": "medium",
                            "reason": "callout bubble often clickable/hoverable"
                        }
                    ]
                }
            }
...
@keyframes vw-blink {
    ...
    const getTitle = (step) => {
        ...
        // Use raw.view or raw.encoding for the title
    ...
    rawSteps.forEach(step => {
        ...
        // --- CHANGE 1: GROUP BY A SHARED ID, NOT A SELECTOR ---
        // Using target_view_id (from your new data) ensures all steps 
        // regarding the "Total XA Line" get grouped into one "Component"
        let groupKey = step.targets?.target_view_id || 'General_Overview';

        // --- CHANGE 2: COLLECT ALL POSSIBLE SELECTORS ---
        // We need to know EVERY selector that belongs to this group
        // so the hover handler knows to trigger the update.
        ...
        if (!merged.has(groupKey)) {
            merged.set(groupKey, {
                ...
                rawText: '',
                allSelectors: new Set() // Using a Set to keep unique selectors
            });
        }

        const entry = merged.get(groupKey);
        entry.rawText += ' ' + (step.text || "");
        currentSelectors.forEach(sel => entry.allSelectors.add(sel));
    });

    console.log('Groups:', Array.from(merged.keys()));

    return Array.from(merged.values()).map(e => ({ 
        ...e, 
        content: categorize(e.rawText),
        // Convert Set back to Array for the hover handler to loop through
        selectors: Array.from(e.allSelectors) 
    }));
}
...
`;
        ...
        <div class="vw-insp-scroll-area">
          ...
          <div class="vw-chat-container">
            ...
            const render = (s) => {
                if (!s) return;
                console.log('render called:', s.step_id, s.title, s.content);
    ...
    for (let step of steps) {
        ...
        // Replace your selector matching logic with this:
const isMatch = step.selectors.some(sel => {
    try {
        if (!sel || sel === 'svg') return false;
        
        // Strip attribute filters like [fill="..."] before matching
        const cleanSel = sel.replace(/\[.*?\]/g, '').trim();
        if (!cleanSel) return false;
        
        return target.matches(cleanSel) || !!target.closest(cleanSel);
    ...
    if (match) {
    render(match);
    this._applyVisualFeedback(target);
} else if (!match && (target.tagName === 'svg' || target.tagName === 'IMG')) {
    render(overview);
  ...
  return data.reply;
    ...
    if (selector && selector !== 'svg') {
        ...
        _teardown() {
            ...
            const left = document.getElementById('vw-left'); if (left) left.remove();
const right = document.getElementById('vw-right'); if (right) right.remove();
