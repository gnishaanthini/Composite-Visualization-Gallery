(function () {
    ...
    {
        "step_id": "step_1",
        "text": "This visualization compares media‑driven fear topics over time. You’ll see colored bands for each topic, a shared timeline, right‑side labels, a legend, and a crosshair with a numeric tooltip.",
        "step_type": "structure",
        "targets": {
    ...
    {
        "step_id": "step_2",
        "text": "Use the bands for an overview of rises and lulls; the floating tooltip provides precise values for a single date across all bands.",
        "step_type": "structure",
        "targets": {
            "target_view_id": "main_overview",
            "resolvedSelector": "#myChart-graph-id0-plots-bl-1 path",
            "raw": {
                "view": {
                    "candidates": [
                        {
                            "selector": "#myChart-graph-id0",
                            "confidence": "high",
                            "reason": "top-level chart group for the main view"
                        },
                        {
                            "selector": "#myChart-graph-id0-plotarea",
                            "confidence": "high",
                            "reason": "explicit plot area container"
                        },
                        {
                            "selector": "#myChart-graph-id0-plots-bl-1",
                            "confidence": "high",
                            "reason": "container holding all filled area series"
                        }
                    ]
                },
                "encoding": {
                    "candidates": [
                        {
                            "selector": "#myChart-graph-id0-plots-bl-1 path",
                            "confidence": "high",
                            "reason": "all filled area marks that encode the series"
                        },
                        {
                            "selector": "#myChart-graph-id0-plots-bl-2 path",
                            "confidence": "medium",
                            "reason": "overlay line paths for each series"
                        }
                    ]
                },
                "interaction": {
                    "candidates": [
                        {
                            "selector": "#myChart-graph-id0-hover",
                            "confidence": "high",
                            "reason": "dedicated hover layer for interactions"
                        },
                        {
                            "selector": "#myChart-graph-id0-crosshair-x-path",
                            "confidence": "high",
                            "reason": "interactive crosshair over the plot"
                        }
                    ]
                }
            }
    ...
    {
        "step_id": "step_3",
        "text": "Each band charts Google Trends interest (Intensity) for one topic from Mar 2007 to Nov 2021.",
        "step_type": "data",
        "targets": {
            "target_view_id": "main_overview",
            "resolvedSelector": "#myChart-graph-id0-plots-bl-1 path",
    ...
    {
        "step_id": "step_4",
        "text": "Read the colored area’s height at any date as Zika’s intensity; a higher specific point means stronger search interest that day.",
        "step_type": "encoding",
        "targets": {
            "target_view_id": "series_zika",
            "resolvedSelector": "#myChart-graph-id0-plotset-plot-13-area-path",
            "raw": {
                "view": {
                    "candidates": [
                        {
                            "selector": "#myChart-graph-id0-plot-13-bl-1-c",
                            "confidence": "high",
                            "reason": "container for Zika area series"
                        }
                    ]
                },
                "encoding": {
                    "candidates": [
                        {
                            "selector": "#myChart-graph-id0-plotset-plot-13-area-path",
                            "confidence": "high",
                            "reason": "filled area mark for Zika"
                        },
                        {
                            "selector": "path[fill=\"#FB301E\" i]",
                            "confidence": "high",
                            "reason": "targets Zika by its unique fill color"
                        },
                        {
                            "selector": "#myChart-graph-id0-plotset-plot-13-path",
                            "confidence": "medium",
                            "reason": "overlay line for Zika series"
                        }
                    ]
                },
                "interaction": {
                    "candidates": [
                        {
                            "selector": "#myChart-graph-id0-legend-item_13",
                            "confidence": "high",
                            "reason": "legend item controlling Zika visibility/hover"
                        },
                        {
                            "selector": "#myChart-graph-id0-legend-marker_13-path",
                            "confidence": "high",
                            "reason": "legend marker for Zika"
                        }
                    ]
                }
            }
    ...
    {
        "step_id": "step_5",
        "text": "Follow time from left to right; all bands share these same dates and tick labels.",
        "step_type": "encoding",
        "targets": {
            "target_view_id": "x_axis",
            "resolvedSelector": "text.myChart-graph-id0-scale-x-item",
            "raw": {
                "view": {
                    "candidates": [
                        {
                            ...
                            "confidence": "high",
                            "reason": "axis baseline and tick marks"
                        },
                        {
                            "selector": "text.myChart-graph-id0-scale-x-item",
                            "confidence": "high",
                            "reason": "x-axis tick label texts"
                        }
                    ]
                },
                "encoding": {
                    "candidates": [
                        {
                            "selector": "text.myChart-graph-id0-scale-x-item",
                            "confidence": "high",
                            "reason": "text labels encode temporal positions"
                        }
                    ]
                },
                "interaction": {
                    "candidates": [
                        {
                            "selector": "#myChart-graph-id0-guide-scale-x-label-1-path",
                            "confidence": "medium",
                            "reason": "hover label callout anchored to x-axis"
                        }
                    ]
                }
            }
    ...
    {
        "step_id": "step_6",
        "text": "Match each small colored square to the identically colored area band and the same color text in the tooltip.",
        "step_type": "encoding",
        "targets": {
            "target_view_id": "legend_panel",
            "resolvedSelector": "g#myChart-graph-id0-legend-c path[id^=\"myChart-graph-id0-legend-marker_\"]",
            "raw": {
                "view": {
                    "candidates": [
                        {
                            ...
                            "confidence": "high",
                            "reason": "legend container"
                        },
                        {
                            "selector": "#myChart-graph-id0-legend-c",
                            "confidence": "high",
                            "reason": "legend contents layer"
                        }
                    ]
                },
                "encoding": {
                    "candidates": [
                        {
                            "selector": "g#myChart-graph-id0-legend-c path[id^=\"myChart-graph-id0-legend-marker_\"]",
                            "confidence": "high",
                            "reason": "colored legend markers for each series"
                        }
                    ]
                },
                "interaction": {
                    "candidates": [
                        {
                            ...
                            "confidence": "high",
                            "reason": "legend item texts typically clickable/togglable"
                        },
                        {
                            "selector": "g#myChart-graph-id0-legend-c path[id^=\"myChart-graph-id0-legend-marker_\"]",
                            "confidence": "high",
                            "reason": "legend marker rectangles as interactive targets"
                        }
                    ]
                }
            }
    ...
    {
        "step_id": "step_7",
        "text": "Use the topic labels on the right; each label aligns horizontally with its corresponding colored band.",
        "step_type": "structure",
        "targets": {
            "target_view_id": "right_labels",
            "resolvedSelector": "text[id^=\"myChart-graph-id0-scale_y_\"]",
            "raw": {
                "view": {
                    "candidates": [
                        {
                            "selector": "text[id^=\"myChart-graph-id0-scale_y_\"]",
                            "confidence": "high",
                            "reason": "right-side series labels"
                        },
                        {
                            "selector": "#myChart-text",
                            "confidence": "medium",
                            "reason": "container group for chart text including right labels"
                        }
                    ]
                },
                "encoding": {
                    "candidates": [
                        {
                            "selector": "text[id^=\"myChart-graph-id0-scale_y_\"]",
                            "confidence": "high",
                            "reason": "category labels for each series aligned at right"
                        }
                    ]
                },
                "interaction": {
    ...
    {
        "step_id": "step_8",
        "text": "Spot the single tall red peak near 2016; that specific mark indicates a brief, intense Zika surge, typical of event‑driven coverage.",
    ...
    {
        "step_id": "step_9",
        "text": "Look for repeated medium bumps across years; these marks show cyclical spikes in interest about violent video games, suggesting recurring news cycles.",
        "step_type": "analytical",
        "targets": {
            "target_view_id": "series_violent_videogames",
            "resolvedSelector": "#myChart-graph-id0-plotset-plot-2-area-path",
            "raw": {
                "view": {
                    "candidates": [
                        {
                            ...
                            "confidence": "high",
                            "reason": "container for Violent Video Games series"
                        }
                    ]
                },
                "encoding": {
                    "candidates": [
                        {
                            "selector": "#myChart-graph-id0-plotset-plot-2-area-path",
                            "confidence": "high",
                            "reason": "filled area mark for Violent Video Games"
                        },
                        {
                            "selector": "path[fill=\"#7CA82B\" i]",
                            "confidence": "high",
                            "reason": "targets series by its fill color"
                        },
                        {
                            "selector": "#myChart-graph-id0-plotset-plot-2-path",
                            "confidence": "medium",
                            "reason": "overlay line for the series"
                        }
                    ]
                },
                "interaction": {
                    "candidates": [
                        {
                            "selector": "#myChart-graph-id0-legend-item_2",
                            "confidence": "high",
                            "reason": "legend item for Violent Video Games"
                        },
                        {
                            "selector": "#myChart-graph-id0-legend-marker_2-path",
                            "confidence": "high",
                            "reason": "legend marker for Violent Video Games"
                        }
                    ]
                }
            }
    ...
    {
        "step_id": "step_10",
        "text": "Scan vertically on the same date across bands; peaks rarely align, meaning these fears usually spike at different times rather than together.",
        "step_type": "analytical",
        "targets": {
            "target_view_id": "main_overview",
            "resolvedSelector": "#myChart-graph-id0-plots-bl-1 path",
    ...
    {
        "step_id": "step_11",
        "text": "Hover along the timeline to move the vertical guide; the tooltip lists each topic’s percentage at that exact date for side‑by‑side comparison.",
        "step_type": "interaction",
        "targets": {
            "target_view_id": "tooltip_detail",
            "resolvedSelector": "#myChart-graph-id0-guide-label-142-1-path",
            "raw": {
                "view": {
                    "candidates": [
                        {
                            "selector": "#myChart-guide-c",
                            "confidence": "high",
                            "reason": "tooltip is drawn on the guide layer"
                        }
                    ]
                },
                "encoding": {
                    "candidates": [
                        {
                            "selector": "#myChart-graph-id0-guide-label-142-1-path",
                            "confidence": "high",
                            "reason": "tooltip background shape"
                        },
                        {
                            "selector": "#myChart-graph-id0-guide-label-142-1",
                            "confidence": "high",
                            "reason": "tooltip text content"
                        }
                    ]
                },
                "interaction": {
                    "candidates": [
                        {
                            "selector": "path[id^=\"myChart-graph-id0-guide-label-142-\"][id$=\"-marker-path\"]",
                            "confidence": "high",
                            "reason": "colored series markers within tooltip"
                        }
                    ]
                }
            }
    ...
    {
        "step_id": "step_12",
        "text": "Workflow: first scan the colored bands for large peaks, then hover a chosen date to read exact percentages, and finally use the legend to confirm topics.",
        "step_type": "interaction",
        "targets": {
            "target_view_id": "main_overview",
            "resolvedSelector": "#myChart-graph-id0-plots-bl-1 path",
    ...
    {
        "step_id": "step_13",
        "text": "The tooltip percentages represent relative search interest for that date, enabling fair comparisons across topics.",
        "step_type": "data",
        "targets": {
            "target_view_id": "tooltip_detail",
            "resolvedSelector": "#myChart-graph-id0-guide-label-142-1-path",
    ...
    {
        "step_id": "step_14",
        "text": "A thin outline tracks the same values over the filled area; use the highest outlined point as the precise peak.",
        "step_type": "encoding",
        "targets": {
            "target_view_id": "series_violent_videogames",
            "resolvedSelector": "#myChart-graph-id0-plotset-plot-2-area-path",
...
`;
    ...
    for (const step of steps) {
        ...
        const isMatch = step.selectors.some(sel => {
            ...
            try {
                // Match by class names extracted from selector (catches <area> elements)
                ...
                // Also match by ID prefix from selector
                const idMatch = sel.match(/#([a-zA-Z0-9_-]+)/);
                if (idMatch && target.id && target.id.startsWith(idMatch[1].replace(/-[^-]*$/, ''))) return true;

                // Fallback: standard DOM matching with attribute filters stripped
