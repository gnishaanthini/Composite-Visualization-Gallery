(function () {
    ...
    {
        "step_id": "step_1",
        "text": "This chart tracks daily price with candlestick marks, moving‑average lines, and trading volume. A blue range strip above provides an overview and controls which dates appear below.",
        "step_type": "structure",
        "targets": {
    ...
    {
        "step_id": "step_2",
        "text": "The bottom timeline is shared: each individual candlestick mark, every moving‑average segment, and each volume bar aligns to the same date labels.",
        "step_type": "structure",
        "targets": {
            "target_view_id": "x_axis_time",
            "resolvedSelector": "text[text-anchor='middle'][fill='#777' i]",
            "raw": {
                "view": {
                    "candidates": [
                        {
                            "selector": "path[stroke='#777' i][stroke-linecap='round']",
                            "confidence": "medium",
                            "reason": "axis baseline/ticks drawn with darker stroke"
                        }
                    ]
                },
                "encoding": {
                    "candidates": [
                        {
                            "selector": "text[text-anchor='middle'][fill='#777' i]",
                            "confidence": "high",
                            "reason": "x-axis tick labels (time)"
                        }
                    ]
                },
                "interaction": {
    ...
    {
        "step_id": "step_3",
        "text": "Use the faint price labels to read value: they anchor the height of each candlestick body, wick, and moving‑average segment.",
        "step_type": "structure",
        "targets": {
            "target_view_id": "y_axis_price",
            "resolvedSelector": "text[text-anchor='start'][fill='#777' i]",
            "raw": {
                "view": {
                    "candidates": [
                        {
                            ...
                            "confidence": "medium",
                            "reason": "horizontal gridlines forming the y-axis grid"
                        }
                    ]
                },
                "encoding": {
                    "candidates": [
                        {
                            "selector": "text[text-anchor='start'][fill='#777' i]",
                            "confidence": "high",
                            "reason": "y-axis tick labels (price)"
                        }
                    ]
                },
                "interaction": {
    ...
    {
        "step_id": "step_4",
        "text": "Dates run daily from 04‑14 to 05‑26. Prices near the left labels span roughly 17,000 to 18,500 units.",
        "step_type": "data",
        "targets": {
            "target_view_id": "candlestick_marks",
            "resolvedSelector": "path[fill='#ef232a' i][stroke='#ef232a' i]",
            "raw": {
                "view": {
                    "candidates": [
                        {
                            "selector": "g",
                            "confidence": "low",
                            "reason": "top-level grouping that contains the chart elements including candlesticks"
                        }
                    ]
                },
                "encoding": {
                    "candidates": [
                        {
                            "selector": "path[fill='#ef232a' i][stroke='#ef232a' i]",
                            "confidence": "high",
                            "reason": "red candlestick bodies/wicks"
                        },
                        {
                            "selector": "path[fill='#14b143' i][stroke='#14b143' i]",
                            "confidence": "high",
                            "reason": "green candlestick bodies/wicks"
                        }
                    ]
                },
                "interaction": {
                    "candidates": [
                        {
                            "selector": "path[fill='#ef232a' i][stroke='#ef232a' i]",
                            "confidence": "medium",
                            "reason": "candlestick paths typically serve as hover targets"
                        },
                        {
                            "selector": "path[fill='#14b143' i][stroke='#14b143' i]",
                            "confidence": "medium",
    ...
    {
        "step_id": "step_5",
        "text": "Each individual candlestick mark shows one day: the rectangle spans open to close and the thin wick shows high and low. Red closes below open; green closes above.",
        "step_type": "encoding",
        "targets": {
            "target_view_id": "candlestick_marks",
            "resolvedSelector": "path[fill='#ef232a' i][stroke='#ef232a' i]",
    ...
    {
        "step_id": "step_6",
        "text": "Match colors using the legend’s colored dot and line samples: red is MA5, dark blue is MA10, and teal is MA20.",
        "step_type": "encoding",
        "targets": {
            "target_view_id": "legend_ma",
            "resolvedSelector": "path[transform='translate(694.9639 36)'][fill='none']",
            "raw": {
                "view": {
                    "candidates": [
                        {
                            "selector": "path[transform='translate(694.9639 36)'][fill='none']",
                            "confidence": "high",
                            "reason": "legend entry container for MA5"
                        },
                        {
                            "selector": "path[transform='translate(763.1689 36)'][fill='none']",
                            "confidence": "high",
                            "reason": "legend entry container for MA10"
                        },
                        {
                            "selector": "path[transform='translate(838.4111 36)'][fill='none']",
                            "confidence": "high",
                            "reason": "legend entry container for MA20"
                        }
                    ]
                },
                "encoding": {
                    "candidates": [
                        {
                            "selector": "path[transform='translate(694.9639 36)'][stroke='#c23531' i]",
                            "confidence": "high",
                            "reason": "legend swatch for MA5"
                        },
                        {
                            "selector": "path[transform='translate(763.1689 36)'][stroke='#2f4554' i]",
                            "confidence": "high",
                            "reason": "legend swatch for MA10"
                        },
                        {
                            "selector": "path[transform='translate(838.4111 36)'][stroke='#61a0a8' i]",
                            "confidence": "high",
                            "reason": "legend swatch for MA20"
                        }
                    ]
                },
                "interaction": {
                    "candidates": [
                        {
                            "selector": "path[transform='translate(694.9639 36)'][fill='none']",
                            "confidence": "high",
                            "reason": "clickable hitbox for MA5 legend item"
                        },
                        {
                            "selector": "path[transform='translate(763.1689 36)'][fill='none']",
                            "confidence": "high",
                            "reason": "clickable hitbox for MA10 legend item"
                        },
                        {
                            "selector": "path[transform='translate(838.4111 36)'][fill='none']",
                            "confidence": "high",
                            "reason": "clickable hitbox for MA20 legend item"
                        }
                    ]
                }
            }
    ...
    {
        "step_id": "step_7",
        "text": "In the MA5 line, each specific point’s height shows the 5‑day average price for that date, and the connecting stroke reveals short‑term direction.",
        "step_type": "encoding",
        "targets": {
            "target_view_id": "ma5_line",
            "resolvedSelector": "g[clip-path='url(#zr0-c0)'] path[fill='none'][stroke='#c23531' i]",
            "raw": {
                "view": {
                    "candidates": [
                        {
                            ...
                            "confidence": "high",
                            "reason": "clipped drawing region for MA5"
                        }
                    ]
                },
                "encoding": {
                    "candidates": [
                        {
                            "selector": "g[clip-path='url(#zr0-c0)'] path[fill='none'][stroke='#c23531' i]",
                            "confidence": "high",
                            "reason": "MA5 line path"
                        }
                    ]
                },
                "interaction": {
                    "candidates": [
                        {
                            "selector": "g[clip-path='url(#zr0-c0)'] path[fill='none'][stroke='#c23531' i]",
                            "confidence": "medium",
                            "reason": "line path as hover target"
                        }
                    ]
                }
            }
    ...
    {
        "step_id": "step_8",
        "text": "Each green vertical bar encodes volume for that date; taller bars indicate heavier trading activity.",
        "step_type": "encoding",
        "targets": {
            "target_view_id": "volume_bars",
            "resolvedSelector": "path[fill='#7fbe9e' i]",
            "raw": {
                "view": {
                    "candidates": [
                        {
                            "selector": "g",
                            "confidence": "low",
                            "reason": "root grouping that contains the volume bar paths"
                        }
                    ]
                },
                "encoding": {
                    "candidates": [
                        {
                            "selector": "path[fill='#7fbe9e' i]",
                            "confidence": "high",
                            "reason": "volume columns drawn as filled paths"
                        }
                    ]
                },
                "interaction": {
                    "candidates": [
                        {
                            "selector": "path[fill='#7fbe9e' i]",
                            "confidence": "medium",
                            "reason": "bars commonly used as hover/click targets"
                        }
                    ]
                }
            }
    ...
    {
        "step_id": "step_9",
        "text": "Follow the dark‑blue MA10 segments drifting downward; a sustained slope indicates medium‑term weakness beyond day‑to‑day noise.",
        "step_type": "analytical",
        "targets": {
            "target_view_id": "ma10_line",
            "resolvedSelector": "g[clip-path='url(#zr0-c1)'] path[fill='none'][stroke='#2f4554' i]",
            "raw": {
                "view": {
                    "candidates": [
                        {
                            "selector": "g[clip-path='url(#zr0-c1)']",
                            "confidence": "high",
                            "reason": "clipped drawing region for MA10"
                        }
                    ]
                },
                "encoding": {
                    "candidates": [
                        {
                            "selector": "g[clip-path='url(#zr0-c1)'] path[fill='none'][stroke='#2f4554' i]",
                            "confidence": "high",
                            "reason": "MA10 line path"
                        }
                    ]
                },
                "interaction": {
    ...
    {
        "step_id": "step_10",
        "text": "Watch for the red MA5 bending upward and approaching or crossing the MA10 near late May; such a crossover often signals a short‑term momentum shift.",
        "step_type": "analytical",
        "targets": {
            "target_view_id": "ma5_line",
            "resolvedSelector": "g[clip-path='url(#zr0-c0)'] path[fill='none'][stroke='#c23531' i]",
    ...
    {
        "step_id": "step_11",
        "text": "Look for a tall volume bar under a long green candlestick around 04‑22; a volume spike beneath a big specific mark often confirms strong participation.",
        "step_type": "analytical",
        "targets": {
            "target_view_id": "volume_bars",
            "resolvedSelector": "path[fill='#7fbe9e' i]",
    ...
    {
        "step_id": "step_12",
        "text": "Scan sequences of red candlestick marks in early May forming lower closes; repeated red bodies highlight persistent selling pressure.",
        "step_type": "analytical",
        "targets": {
            "target_view_id": "candlestick_marks",
            "resolvedSelector": "path[fill='#ef232a' i][stroke='#ef232a' i]",
    ...
    {
        "step_id": "step_13",
        "text": "Drag the white handles on the blue overview strip to filter dates; the central candlestick marks and the bottom volume bars update together.",
        "step_type": "interaction",
        "targets": {
            "target_view_id": "overview_brush",
            "resolvedSelector": "g[clip-path='url(#zr0-c3)'] path[stroke='#d2dbee' i]",
            "raw": {
                "view": {
                    "candidates": [
                        {
                            "selector": "path[transform='matrix(1,0,0,-1,22.8,91.5)'][stroke='#d2dbee' i][fill-opacity='0']",
                            "confidence": "high",
                            "reason": "brush frame/border container"
                        },
                        {
                            "selector": "path[d='M0 0l1496 0l0 20l-1496 0Z'][transform='matrix(1,0,0,-1,22.8,91.5)'][fill='none']",
                            "confidence": "medium",
                            "reason": "track area path for the brush"
                        }
                    ]
                },
                "encoding": {
                    "candidates": [
                        {
                            "selector": "g[clip-path='url(#zr0-c3)'] path[stroke='#d2dbee' i]",
                            "confidence": "high",
                            "reason": "overview mini-series stroke within left clip region"
                        },
                        {
                            "selector": "g[clip-path='url(#zr0-c4)'] path[stroke='#8fb0f7' i]",
                            "confidence": "high",
                            "reason": "overview mini-series stroke within center clip region"
                        },
                        {
                            "selector": "g[clip-path='url(#zr0-c5)'] path[stroke='#d2dbee' i]",
                            "confidence": "high",
                            "reason": "overview mini-series stroke within right clip region"
                        },
                        {
                            "selector": "g[clip-path='url(#zr0-c4)'] path[fill='#8fb0f7' i]",
                            "confidence": "medium",
                            "reason": "overview area fill showing density in the brush"
                        }
                    ]
                },
                "interaction": {
                    "candidates": [
                        {
                            "selector": "path[transform='matrix(1,0,0,-1,22.8,91.5)'][fill='rgb(135,175,255)']",
                            "confidence": "high",
                            "reason": "selection rectangle of the brush"
                        },
                        {
                            "selector": "path[stroke='#ACB8D1' i][fill='#fff' i]",
                            "confidence": "high",
                            "reason": "drag handles for adjusting the brush window"
                        }
                    ]
                }
            }
    ...
    {
        "step_id": "step_14",
        "text": "Typical workflow: set a date window in the overview, read individual candlestick marks for direction, compare with MA lines for trend, then check tall volume bars for confirmation.",
        "step_type": "interaction",
        "targets": {
            "target_view_id": "overview_brush",
            "resolvedSelector": "g[clip-path='url(#zr0-c3)'] path[stroke='#d2dbee' i]",
