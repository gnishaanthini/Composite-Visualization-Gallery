...
@keyframes vw-blink {
    ...
    rawSteps.forEach(step => {
        ...
        // Collect every selector candidate for this step
        const allSelectors = [
...
`;
    ...
    for (const step of steps) {
        ...
        const isMatch = step.selectors.some(sel => {
            ...
            try {
                // 1. Extract class names from selector and check against target classes
                ...
                // 2. Fallback: strip attribute filters and try DOM matching
